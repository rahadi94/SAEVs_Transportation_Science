...
class Base_Agent(object):
    ...
    def get_score_required_to_win(self):
        ...
        a=True
        if a == True:
            return self.config.average_score_required_to_win
    ...
    def conduct_action(self, action, fleet, env):
        """Conducts an action in the environment"""
        self.next_state, self.reward, self.done, _ = self.environment.step(action, fleet, env)
