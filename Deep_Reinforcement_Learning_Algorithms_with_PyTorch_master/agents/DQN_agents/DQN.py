...
from Deep_Reinforcement_Learning_Algorithms_with_PyTorch_master.exploration_strategies.Epsilon_Greedy_Exploration import Epsilon_Greedy_Exploration
...
class DQN(Base_Agent):
    ...
    def step(self, fleet, env):
        ...
        while not self.done:
            self.action = self.pick_action(fleet)
    ...
    def pick_action(self, fleet, state=None):
    ...
    def save_models(self):
        torch.save(self.q_network_local.state_dict(), 'result/q_network')
