...
from Deep_Reinforcement_Learning_Algorithms_with_PyTorch_master.exploration_strategies.OU_Noise_Exploration import OU_Noise_Exploration
...
class DDPG(Base_Agent):
    ...
    def step(self):
        ...
        while not self.done:
            ...
            if self.time_for_critic_and_actor_to_learn() and not self.evaluation:
    ...
    def check_constraints(self):
        # NoC = 0
        # NoP = [1, 2, 4, 1, 2, 4]
        # for i in ['fast_one', 'fast_two', 'fast_four', 'slow_one', 'slow_two', 'slow_four']:
        #     j = 0
