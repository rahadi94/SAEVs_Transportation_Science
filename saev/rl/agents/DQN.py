...
class Agent:
    ...
    def take_action(self, vehicle, charging_stations, vehicles, waiting_list, env, episode, sub_learner):
        ...
        vehicle.r_modified = float(-(vehicle.reward['charging'] + vehicle.reward['distance'] * 2 - vehicle.reward[
            'revenue'] - vehicle.reward['discharging'] + vehicle.reward['queue'] + vehicle.reward['sub_missed']))
